...
function renderAgentHeader(
  ...
  const subtitle = agent.identity?.theme?.trim() || t("agents.headerSubtitle");
    ...
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          ...
          <div>${skillFilter ? t("agents.overview.selectedCount", { count: String(skillCount) }) : t("agents.overview.allSkills")}</div>
        </div>
      </div>
