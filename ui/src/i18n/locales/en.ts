...
export const en: TranslationMap = {
  ...
  agents: {
    ...
    context: {
      title: "Agent Context",
      subtitleWorkspace: "Workspace, identity, and model configuration.",
      subtitleScheduling: "Workspace and scheduling targets.",
      workspace: "Workspace",
      primaryModel: "Primary Model",
      identityName: "Identity Name",
      identityEmoji: "Identity Emoji",
    ...
    cron: {
      ...
      agentCronSub: "Scheduled jobs targeting this agent.",
    ...
    tools: {
      ...
      optional: "optional",
      refreshing: "Refreshing tool catalog…",
    },
    skills: {
      title: "Skills",
